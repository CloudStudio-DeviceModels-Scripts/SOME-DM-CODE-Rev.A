...
# Parsing Script – SOME-DM-CODE - Rev. A

This **Parsing** script is designed for the **SOME-DM-CODE** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – SOME-DM-CODE Rev. A

Este script de **Parsing** está diseñado para el modelo **SOME-DM-CODE** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
